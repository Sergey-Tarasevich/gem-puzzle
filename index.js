class GemPuzzle {
    ...
    buildFirstPage() {
        ...
        firsPageNode.textContent = 'Please click on "CLICK HERE and START"';
    ...
    buildHeader() {
        ...
        buttonShuffleAndStart.textContent = 'CLICK HERE and START';
    ...
    fillPuzzleBlocks() {
        ...
        for (let matrixIndex = 0; matrixIndex < this.matrixOfGamingValues.length; matrixIndex += 1) {
            for (
                let arrayIndex = 0; arrayIndex < this.matrixOfGamingValues[matrixIndex].length; arrayIndex += 1
            ) {
...
// try to add 2 var play music with html - js
